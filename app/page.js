...
useEffect(()=>{
  ...
  return(
    ...
    <div>
    <Header />
    <p className="text-blue-400 text-md md:text-lg lg:text-3xl text-center pt-20 pb-5">Hi,<br/> <span className="text-blue-400">{address?.slice(0,6)}</span> </p>
    <p className="text-green-400 text-md md:text-lg lg:text-3xl text-center pt-3 pb-3">My Bank Balance:<span >{bankbalance}</span> </p>
    <div className="bg-red-400 flex mx-5 flex-col py-10 lg:py-24 lg:space-y-8 rounded-xl lg:mx-[400px] md:justify-center">
      <p className="text-white text-center text-xl ">My deposit Section</p>
    <div className="flex flex-col px-10 lg:px-0 space-y-2 lg:space-y-0 justify-center space-x-4">
    ...
    <div className="bg-blue-400 flex mt-5 flex-col lg:py-24 lg:space-y-8 rounded-xl lg:mx-[400px] lg:justify-center">
    ...
    <div className="flex justify-center space-x-4">
      ...
      <button className="text-white bg-green-400 rounded-lg px-4 py-2 lg:mx-[400px]" onClick={withdrawbro} >Withdraw Here</button>
    </div>
    </div>
    <div className="bg-green-400 flex mt-5 flex-col lg:py-24 lg:space-y-8 rounded-xl lg:mx-[400px] lg:justify-center">
